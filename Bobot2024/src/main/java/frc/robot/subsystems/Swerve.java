...
public class Swerve extends SubsystemBase {
    ...
    public void lockDrive(Translation2d translation, boolean fieldRelative, boolean isOpenLoop, double setPoint) {
        SwerveModuleState[] swerveModuleStates = 
            Constants.Swerve.swerveKinematics.toSwerveModuleStates(
                fieldRelative ? ChassisSpeeds.fromFieldRelativeSpeeds(
                    translation.getX(),
                    translation.getY(),
                    anglePID.calculate(getHeading().getDegrees(), setPoint),
                    getHeading()
                )
                : new ChassisSpeeds(
                    translation.getX(),
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates) {
        SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, Constants.Swerve.autoMaxSpeed);
    ...
    public void autoDrive(ChassisSpeeds robotSpeeds) {
    ...
    public void setHeading(Rotation2d heading){ //RESETS POSE
